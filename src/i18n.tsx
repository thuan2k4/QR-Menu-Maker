...
const TRANSLATIONS = {
  vi: {
    ...
    landing: {
      ...
      demoImageAlt2: 'Danh sách cửa hàng và quản lý',
      demoImageAlt3: 'Trang QR, analytics và cửa hàng',
      demoImageAlt4: 'Trang quản lý menu và sản phẩm',
      demoImageAlt5: 'Cài đặt cửa hàng và ảnh bìa',
      demoImageAlt6: 'Tùy chỉnh giao diện menu với preview di động',
      demoImageAlt7: 'Demo menu công khai với template sáng',
      demoImageAlt8: 'Demo menu công khai với template tối giản',
  ...
  en: {
    ...
    landing: {
      ...
      demoImageAlt2: 'Store list and management',
      demoImageAlt3: 'Store QR and analytics overview',
      demoImageAlt4: 'Menu and product management editor',
      demoImageAlt5: 'Store info and cover image settings',
      demoImageAlt6: 'Theme editor with mobile preview',
      demoImageAlt7: 'Public menu sample with bright template',
      demoImageAlt8: 'Public menu sample with minimal template',
